...
- iOS via the [Hoowlib App Store link](https://apps.apple.com/de/app/hoowlib/id6748452885) ![Static Badge](https://img.shields.io/badge/Version-0.16.0-green)
- TestFlight ![Static Badge](https://img.shields.io/badge/Version-0.16.0-blue)
- Android via direct APK download: [hoowlib-apk-files](https://deckelmouck.de/apk/) ![Static Badge](https://img.shields.io/badge/Version-0.16.0-orange)
